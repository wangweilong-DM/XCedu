...
public class XcServiceList {
    ...
    public static final String XC_SERVICE_MANAGE_COURSE = "xc-service-manage_cms_client-course";
    public static final String XC_SERVICE_MANAGE_MEDIA = "xc-service-manage_cms_client-media";
    public static final String XC_SERVICE_MANAGE_CMS = "xc-service-manage_cms_client-cms";
